    ...
    >
      <nav className="container" style={{ display: "flex", alignItems: "center", justifyContent: "space-between", height: 72 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          {resumeUrl && (
            <a href={resumeUrl} download target="_blank" rel="noreferrer" className="btn btn-primary nav-cv-btn">
      ...
      {open && (
        ...
        >
          ...
          {resumeUrl && (
            <a href={resumeUrl} download target="_blank" rel="noreferrer" className="btn btn-primary" style={{ marginTop: 8, justifyContent: "center" }}>
              <Download size={14} /> Download CV
            </a>
          )}
        </div>
